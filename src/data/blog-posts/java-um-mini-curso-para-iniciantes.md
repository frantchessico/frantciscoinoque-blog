---
title: JAVA - Mini Curso
publishDate: 15 Oct 2023
description: Este mini curso é uma imersão ágil e dinâmica no vasto universo da linguagem de programação Java. Em um curto espaço de tempo, você terá acesso a conceitos fundamentais, desde variáveis e estruturas de controle até princípios avançados de orientação a objetos.
